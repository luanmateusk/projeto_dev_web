...
function cuphead() {
  ...
  // type 'cuphead' on your keyboard
  let key = [67, 85, 80]
  let ck = 0
  let max = key.length

  let cuphead = function () {
  ...
  let data = 'https://mir-s3-cdn-cf.behance.net/project_modules/disp/6c7189111130979.5ffc70ceeeab3.gif'
...
function naruto() {
  ...
  let data = 'https://i.pinimg.com/originals/ae/89/c2/ae89c2b34198141f73e42583b55ad2d4.gif'
